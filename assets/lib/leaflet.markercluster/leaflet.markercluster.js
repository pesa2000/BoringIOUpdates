    ...
    var t = (L.MarkerClusterGroup = L.FeatureGroup.extend({
        ...
        zoomToShowLayer: function (e, t) {
            ...
            var i = function () {
                (!e._icon && !e.__parent._icon) ||
                    ...
                    (this._map.off("moveend", i, this), this.off("animationend", i, this), e._icon ? t() : e.__parent._icon && (this.once("spiderfied", t, this), e.__parent.spiderfy()));
            };
            e._icon && this._map.getBounds().contains(e.getLatLng())
                ...
                : (this._map.on("moveend", i, this), this.on("animationend", i, this), e.__parent.zoomToBounds());
        },
        onAdd: function (e) {
            this._map = e;
            var t, i, n;
        ...
        _showCoverage: function (e) {
            ...
            this._inZoomAnimation ||
                ...
                e.layer.getChildCount() > 2 && e.layer !== this._spiderfied && ((this._shownPolygon = new L.Polygon(e.layer.getConvexHull(), this.options.polygonOptions)), t.addLayer(this._shownPolygon)));
        },
                    ...
                    (this._ignoreMove = !0),
                        this._topClusterLevel._recursively(n, e, s, function (s) {
                            var o,
                                ...
                                h = s._markers;
                            for (
                                n.contains(a) || (a = null), s._isSingleParent() && e + 1 === t ? (r.removeLayer(s), s._recursivelyAddChildrenToMap(null, t, n)) : (s.clusterHide(), s._recursivelyAddChildrenToMap(a, t, n)), i = h.length - 1;
                                i >= 0;
                                i--
                            )
    ...
    L.Marker.include({
        ...
        (L.DistanceGrid.prototype = {
            ...
            getNearObject: function (e) {
                ...
                for (t = u - 1; u + 1 >= t; t++)
                    if ((r = this._grid[t]))
                        for (i = l - 1; l + 1 >= i; i++) if ((s = r[i])) for (n = 0, o = s.length; o > n; n++) (a = s[n]), (h = this._sqDist(_[L.Util.stamp(a)], e)), (d > h || (d >= h && null === c)) && ((d = h), (c = a));
                return c;
            },
        ...
        L.MarkerCluster.include({
            _animationSpiderfy: function (e, t) {
                var i,
                    ...
                    m = f.opacity;
                for (
                    void 0 === m && (m = L.MarkerClusterGroup.prototype.options.spiderLegPolylineOptions.opacity),
                        p ? ((f.opacity = 0), (f.className = (f.className || "") + " leaflet-cluster-spider-leg")) : (f.opacity = m),
                        l._ignoreMove = !0,
                        i = 0;
                    i < e.length;
                    i++
                ...
                for (l._forceLayout(), l._animationStart(), i = e.length - 1; i >= 0; i--)
                    (a = u.layerPointToLatLng(t[i])),
                        ...
                        p && ((r = n._spiderLeg), (s = r._path), (s.style.strokeDashoffset = 0), r.setStyle({ opacity: m }));
                this.setOpacity(0.3),
                    (l._ignoreMove = !1),
                    setTimeout(function () {
