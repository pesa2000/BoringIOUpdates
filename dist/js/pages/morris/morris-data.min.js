$(function () {
    ...
    Morris.Area({
        ...
        pointSize: 3,
        fillOpacity: 0,
        pointStrokeColors: ["#5f76e8", "#ff4f70", "#212529"],
        behaveLikeLine: !0,
        gridLineColor: "#e0e0e0",
        lineWidth: 3,
        hideHover: "auto",
        lineColors: ["#5f76e8", "#ff4f70", "#212529"],
        resize: !0,
    }),
        Morris.Area({
            ...
            pointSize: 0,
            fillOpacity: 0.4,
            pointStrokeColors: ["#5f76e8", "#ff4f70"],
            behaveLikeLine: !0,
            gridLineColor: "#e0e0e0",
            lineWidth: 0,
            smooth: !1,
            hideHover: "auto",
            lineColors: ["#5f76e8", "#ff4f70"],
            resize: !0,
        });
    new Morris.Line({
    ...
    Morris.Donut({
        ...
        resize: !0,
        colors: ["#5f76e8", "#22ca80", "#212529"],
    }),
        Morris.Bar({
            element: "morris-bar-chart",
            data: [
                { y: "2006", a: 100, b: 90, c: 60 },
                { y: "2007", a: 75, b: 65, c: 40 },
            ...
            ykeys: ["a", "b", "c"],
            labels: ["A", "B", "C"],
            barColors: ["#ff4f70", "#212529", "#5f76e8"],
            hideHover: "auto",
            gridLineColor: "#eef0f2",
            resize: !0,
        }),
        Morris.Area({
            ...
            lineColors: ["#22ca80", "#5f76e8", "#343a40"],
            xkey: "period",
            ykeys: ["iphone", "ipad", "itouch"],
